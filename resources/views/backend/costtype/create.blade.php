...
@section('content')
    <main id="main" class="main">
        ...
        <hr>
        <div class="card">
            <form method="post" action="{{ route('costtype.store') }}" enccosttype="multipart/form-data" class="row g-3 p-3">
                @csrf
                ...
                <div class="col-12">
                    <button costtype="submit" class="btn btn-primary">Submit</button>
                </div>
            </form>
        </div>
    </main>
